...
class Frown:
    ...
    def intensity(self, value: float) -> None:
        """Set frown intensity, clamped to [0, 1]."""
        if not 0 <= value <= 1:
    ...
    @property
    def count(self) -> int:
        """Total number of frowns sent."""
        return len(self._timestamps)

    @property
    def timestamps(self) -> list[float]:
        """Copy of all frown timestamps."""
    ...
    def has_sent_to(self, room_id: str) -> bool:
        ...
        -------
        bool
            True if a frown was sent to this room.
        """
